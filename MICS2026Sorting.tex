...
\emcomment{list some, not all; not all on github}

\emcomment{How to find things in a repo}
\begin{itemize}
\item \emcomment{2014: strings of different length, first by length, then by number of 1s in binary representation, and then lexicographically  (all in increasing order)}
