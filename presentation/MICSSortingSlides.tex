...
\begin{itemize}
\item Sorting competition allows students explore algorithms, Java, program optimization
\item It's a great problem solving experience
\item It is a fun and exciting event
\item It's a 15-year tradition that brings together students, alumni, and faculty
\item Hope it continues for many years to come!
\item Future issue: AI-proofing
\end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{}
\qquad\qquad\qquad\huge{Questions are welcome!}
\end{frame}
